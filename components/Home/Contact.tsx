...
export const Contact = () => {
  ...
  const appbarTransform = `translate(-${cursorPos.x / 20}px, -${
    cursorPos.y / 20
  }px)`;
  const cardTransform = `translate(-${cursorPos.x / 10}px, -${
    cursorPos.y / 10
  }px)`;
            ...
            <CardContent className="space-y-6">
              <div className="flex justify-center mb-6">
                <Button
                  ...
                  onClick={() =>
                    window.open("https://github.com/iamhvsharma")
                  }
                >
                ...
                <div className="flex flex-col items-center bg-gray-50 p-4 rounded-lg shadow-md hover:shadow-lg transition duration-300 ease-in-out">
                  ...
                  <div className="flex flex-col items-center space-y-2">
                    ...
                    <Button
                      ...
                      onClick={() =>
                        window.open(
                          "https://www.linkedin.com/in/iamhvsharma"
                        )
                      }
                    >
                    ...
                    <Button
                      ...
                      onClick={() => window.open("https://x.com/iamhvsharma")}
                    >
                ...
                <div className="flex flex-col items-center bg-gray-50 p-4 rounded-lg shadow-md hover:shadow-lg transition duration-300 ease-in-out">
                  ...
                  <div className="flex flex-col items-center space-y-2">
                    <Button
                      className="flex items-center bg-gradient-to-r from-gray-800 to-gray-600 text-white py-2 px-4 rounded-lg hover:from-gray-700 hover:to-gray-500 transition duration-300 ease-in-out transform hover:scale-105"
                      onClick={() =>
                        window.open("https://github.com/rushhaaland")
                      }
                    >
                      <FaGithub className="mr-2 text-xl" />
                      Github Profile
